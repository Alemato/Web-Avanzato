...
public class AuthenticationTokenService {
    ...
    public String refreshToken(AuthenticationTokenDetails currentTokenDetails) throws UnsupportedEncodingException {
        ...
        AuthenticationTokenDetails newTokenDetails = new AuthenticationTokenDetails.Builder()
                ...
                .withRegion(currentTokenDetails.getRegion())
                .withStreet(currentTokenDetails.getStreet())
                .withStreetNumber(currentTokenDetails.getStreetNumber())
                .withByography(currentTokenDetails.getByography())
                .withStudyGrade(currentTokenDetails.getStudyGrade())
                .withIssuedDate(issuedDate)
                .withExpirationDate(expirationDate)
